...
const TaskCard = ({ task, handleOpenEditModal, handleDeleteTask }) => {
  return (
    <li className="relative bg-white flex flex-col justify-between border border-gray-300  hover:shadow-xl rounded-md overflow-hidden transition-shadow duration-200 p-8 gap-2">
